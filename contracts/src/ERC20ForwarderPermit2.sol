...
library ERC20ForwarderPermit2 {
    ...
    string internal constant _WITNESS_TYPE_DEF =
        "Witness(bytes32 actionTreeRoot)";

    /// @notice The witness type hash (see https://docs.uniswap.org/contracts/permit2/reference/signature-transfer).
    bytes32 internal constant _WITNESS_TYPEHASH =
        keccak256(bytes(_WITNESS_TYPE_DEF));
