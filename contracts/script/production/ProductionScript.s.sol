...
/// @notice The base of the scripts acting on the production environment ERC20 forwarder proxy, which is owned by a
...
abstract contract ProductionScript is Script {
    ...
    /// @param proxy The production environment ERC20 forwarder proxy to act on.
