...
import {Parsing} from "anoma-pa-evm-1.0.0-rc.8/test/libs/parsing.sol";
...
library TransactionExample {
    ...
    function exampleTransaction(Vm vm) public view returns (Transaction memory txn) {
        txn = vm.parseTransaction(
            "dependencies/anoma-pa-evm-1.0.0-rc.8/test/examples/transactions/test_tx_reg_01_01.bin"
        );
    }
}
